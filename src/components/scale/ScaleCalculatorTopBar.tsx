...
export function ScaleCalculatorTopBar({
  ...
  return (
    <div className="flex-shrink-0 bg-background border-b print:hidden">
      {compactMode && (
      ...
      <div className={cn("py-1 text-center", compactMode && "max-sm:hidden")}>
        <h2
          className="font-bold"
          style={{
      ...
      <div className={cn("flex flex-row flex-nowrap items-center justify-between gap-2 mb-2 px-2", compactMode && "max-sm:hidden")}>
      ...
      <div className={cn("grid grid-cols-[auto_1fr_auto] items-center gap-2 mb-2 px-2", compactMode && "max-sm:hidden")}>
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="outline"
                size="icon"
                className="icon-chip h-8 w-10 sm:h-10 sm:w-14 border-border/70"
        ...
        <div className="flex justify-center">
          <div className="surface-3d flex items-center gap-px rounded-md border p-0.5">
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant={operationType === 'loading' ? 'default' : 'ghost'}
                    className="button-3d h-9 w-28 px-3 text-xs font-semibold sm:h-10 sm:w-36 sm:text-sm"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="outline"
                size="icon"
                className="icon-chip h-8 w-10 sm:h-10 sm:w-14 relative border-border/70"
