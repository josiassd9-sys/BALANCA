...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+8.75rem)] z-[100] mx-auto flex w-full max-w-[420px] flex-col-reverse p-4 sm:inset-x-auto sm:bottom-4 sm:right-4 sm:mx-0 sm:max-h-screen sm:flex-col",
      className
    )}
    {...props}
  />
